// ── SPRINTBRAIN BACKGROUND v2.15.5 — Redesigned context menu (Recent + Folders + Unfiled) ──
...
// ── BUILD CONTEXT MENUS (v2.15.5: Recent + Folders + Unfiled) ─────
function buildContextMenus(data) {
  chrome.contextMenus.removeAll(function() {
    ...
    console.log('[SprintBrain] Context menus v2.15.5 built — ' +
