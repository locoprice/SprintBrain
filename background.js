// ── SPRINTBRAIN BACKGROUND v2.15.2 — Redesigned context menu (Recent + Folders + Unfiled) ──
...
// ── BUILD CONTEXT MENUS (v2.15.2: Recent + Folders + Unfiled) ─────
function buildContextMenus(data) {
  chrome.contextMenus.removeAll(function() {
    ...
    console.log('[SprintBrain] Context menus v2.15.2 built — ' +
