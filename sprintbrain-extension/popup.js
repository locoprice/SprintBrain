...
document.querySelector('.cmd-grid').addEventListener('click',function(e){ if(e.target.dataset.c) insertCmd(e.target.dataset.c); });
...
function showToast(msg){ var t=gi('toast')||document.createElement('div'); t.textContent=msg; }
